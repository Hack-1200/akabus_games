function init() {
    ...
    var blue_bead = new createjs.Bitmap("../assets/images/blue_bead.png");
    var pink_bead = new createjs.Bitmap("../assets/images/pink_bead.png");
    ...
    function Circle(){
        ...
        for ( var i = 0; i < circleCount; i++){
            wood[i] = [];
            wood_line[i] = new createjs.Bitmap("../assets/images/candy_cane.png");
