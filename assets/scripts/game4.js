function init() {
    ...
    var background = new createjs.Bitmap("../assets/images/background2.jpg");
    var field = new createjs.Bitmap("../assets/images/panel2.png");//Shape();
    var buttons = [], buttonTexts = [];
    var cn = cw; if (cw < ch) cn = ch;
    var textSize = cn / 48;
    var maxSteps = 0, steps = 1;
    var target_num = 0, level_num = 1, score_num = 0;
    var again_button = new createjs.Bitmap("../assets/images/again.png")//Shape();
    ...
    var helpButton = new createjs.Bitmap("../assets/images/quest2.png");
    var zone = new createjs.Shape();
    ...
    for (var i = 0; i < 3; i++) {
    	buttons[i] = new createjs.Bitmap("../assets/images/button.png");
	    var zone = new createjs.Shape();
