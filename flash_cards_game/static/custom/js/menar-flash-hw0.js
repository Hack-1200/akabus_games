...
function navbar_fill(){
    ...
    $("#navbar_color_title").html("Color");
    $("#navbar_color").html("(brown)");
    ...
    if ( language_id== 1){
        document.getElementById('navbar_interval').innerHTML = '(' + parseInt(Skorost) + ' ms)';
        ...
        switch(document.getElementById('button_start').innerHTML){
            ...
            case "✐":
                ...
                if (Editbox_otvet.value == parseInt(schot())){
                    ...
                    soundClick(3); 
                    // soundClick2(1,1);
                    if (device.mobile() || device.tablet()) Editbox_otvet.style.fontSize = 20; else Editbox_otvet.style.fontSize = 30;   
                    ...
                    soundClick(4); 
                    // soundClick2(0,1);
                     if (device.mobile() || device.tablet()) Editbox_otvet.style.fontSize = 20; else Editbox_otvet.style.fontSize = 50;                 
                    if (language_id==1){
                        Editbox_otvet.value = "Little mistake";
                    } else{
...
function soundClick(n) {
  if (chered == true) {
    audio.src = "/static/custom/audio/sound_"+n.toString() + '.mp3'
    audio.play()
  }
  else{
    audio2.src = "/static/custom/audio/sound_"+n.toString() + '.mp3'
    audio2.play()
  }
  chered = !chered
}
...
function black_brown(){
    if (language_id==1){
        if (document.getElementById('navbar_color').innerHTML == '(brown)'){
            document.getElementById('navbar_color').innerHTML = '(black)';
            ...
            document.getElementById('navbar_color').innerHTML = '(brown)'
